...
4.Run fungene HMMs.  I ended up using primarily DRAM annotation for the analysis, but the anvio hmm directory can be found in the main page of this git if you are interested in running it on the genomes in this project or elsewhere. The files in this repository required for this analysis are genes.txt, kind.txt, genes.hmm.gz, and noise_cutoff_terms.txt. 
